...
<head>
<meta charset="UTF-8">
<title>Find Employee by Birthday</title>
...
<div class="navbar">
    ...
    <div class="navbar-nav" id="navbarNav">
        ...
        <a href="findbydob.jsp" class="nav-link active">
...
<div class="main-container">
    <div class="card">
        <div class="card-header">
            <i class="fas fa-birthday-cake"></i>Find Employees by Birthday
        </div>
        <div class="card-body">
            <form action="findByBirthday" method="get">
                ...
                <button type="submit" class="btn btn-block">
                    <i class="fas fa-search"></i> Find Employees
                </button>
            </form>
        </div>
    </div>
