...
<body>
    ...
    <nav class="navbar">
        ...
        <div class="navbar-nav" id="navbarNav">
            ...
            <a href="findbyanniversary.jsp" class="nav-link active">
    ...
    <div class="main-container">
        <div class="card">
            <div class="card-header">
                <i class="fas fa-glass-cheers"></i>Find Employees by Anniversary
            </div>
            <div class="card-body">
                <form action="findbyanniversary" method="get">
                    <div class="form-group">
                        <label class="form-label">Enter Wedding Date:</label>
                        <input type="date" name="weddingDate" class="form-control" required>
                    </div>
